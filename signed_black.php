    ...
    <div class="container">
        ...
        <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                ...
                <li class="nav-item">
                    <a class="nav-link-a" href="checkIn.php?id='.$Arr["id"].'">Светлая тема</a>
                </li><!--end nav-item-->
                <li class="nav-item">
            ...
            <button type="button" class="btn btn-green"><a class="btn-a" href="main_black.php">Выйти из аккаунта</a></button>
