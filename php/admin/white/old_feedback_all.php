    ...
    <div class="container">
        ...
        <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                ...
                <li class="nav-item">
                    <a class="nav-link-a" href="../black/checkIn_black.php?house_id='.$house_id.'&type=old_feedback&id='.$Arr["id"].'&role_id=3">Темная тема</a>
                </li><!--end nav-item-->
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link-a active" href="checkIn.php?type=old_feedback&id='.$Arr["id"].'">Старые сообщения</a>
                </li><!--end nav-item-->
            </ul><!--end navbar-nav-->
