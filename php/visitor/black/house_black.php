...
<body class="bg-black">
                ...
                <div class="navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                        ...
                        <?php 
                            echo'
                            <li class="nav-item">
                            <a class="nav-link-a" href="/курсач/php/visitor/white/house.php?id='.$_GET['id'].'">Светлая тема</a>
                            </li><!--end nav-item-->
                            ';
                        ?>
        ...
        <!-- start hero -->
            ...
            <!-- start hero -->
            <h6 class="bg-black text-white fs-2 container text-center">Чтобы оставить отзыв нужно войти в аккаунт</h6>
            <!-- end hero -->  
