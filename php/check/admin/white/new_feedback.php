    ...
    <div class="container">
        ...
        <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                ...
                <li class="nav-item">
                    <a class="nav-link-a" href="../black/checkIn_black.php?feedback_id='.$feedback_id.'&type=new_feedback&id='.$Arr["id"].'&role_id=3">Темная тема</a>
                </li><!--end nav-item-->
                <li class="nav-item">
...
$result = mysqli_query($mysql, "SELECT u.login, u.name, h.address, f.rating, f.text FROM feedback as f JOIN user as u ON f.user_id=u.id JOIN house as h on f.house_id = h.id WHERE f.id = ".$feedback_id."");
            ...
            <section>
                <div class="container text-center">
                    <div class="row">
                        <div class="col">
                            <a class="btn btn-success" href="checkIn.php?type=new_feedback_all&is_published=1&feedback_id='.$feedback_id.'&id='.$Arr["id"].'" role="button">Подтвердить</a>
                        </div>
                        <div class="col">
                            <a class="btn btn-danger" href="checkIn.php?type=new_feedback_all&is_published=0&feedback_id='.$feedback_id.'&id='.$Arr["id"].'" role="button">Отклонить</a>
                        </div>
                    </div>
                </div>
            </section>
