    ...
    <div class="container">
        ...
        <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                ...
                <li class="nav-item">
                    <a class="nav-link-a" href="../white/checkIn.php?type=feedback_after&feedback_id='.$feedback_id.'&id='.$Arr["id"].'">Светлая тема</a>
                </li><!--end nav-item-->
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link-a  active" href="checkIn_black.php?type=feedback_after_all&id='.$Arr["id"].'">Отзывы после проверки</a>
                </li><!--end nav-item-->                
            </ul><!--end navbar-nav-->
...
<br>
        ...
        <br>
            ...
            <!-- start hero -->
            <h6 class="bg-dark text-white fs-2 container text-center">Ваши отзывы после проверки админинстрации</h6>
            <br>
            <br>
        <!-- end hero --> 
';
...
echo'
            ...
            <section class="container text-left">
                <form action="../../check/black/checkIn_black.php?type=feedback_after_all&delete=0&feedback_id='.$feedback_id.'&id='.$Arr["id"].'"   method="POST">
