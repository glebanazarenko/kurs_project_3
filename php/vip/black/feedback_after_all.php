    ...
    <div class="container">
        ...
        <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                ...
                <li class="nav-item">
                    <a class="nav-link-a" href="../white/checkIn.php?type=feedback_after_all&id='.$Arr["id"].'">Светлая тема</a>
                </li><!--end nav-item-->
                <li class="nav-item">
    ...
    while( $product = mysqli_fetch_assoc($result)){
        if($context == NULL){
            ...
            <div style="container-lg text-align: center;">
                ...
                <div class="person_list_div">
                    <a href="checkIn_black.php?type=feedback_after&feedback_id='.$product["id"].'&id='.$Arr["id"].'" class="person_list_row">
